...
for i in range(4):
    ...
    p2018 = PPPP.at[i,"2018"]
    p2019 = PPPP.at[i,"2019"]
    p2020 = PPPP.at[i,"2020"]
    p2021 = PPPP.at[i,"2021"]
    p2022 = PPPP.at[i,"2022"]
    p2023 = PPPP.at[i,"2023"]
    p2024 = PPPP.at[i,"2024"]
...
def countries2024():
    ...
    merged_df.to_csv('countries_in_2024_final.csv')
